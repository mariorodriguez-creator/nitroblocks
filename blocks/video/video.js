...
function embedYoutube(url, autoplay, background) {
  ...
  temp.innerHTML = `<div class="video-embed video-embed-youtube">
    <iframe src="https://www.youtube.com/embed/${vid || embed}?rel=0&v=${vid}${suffix}"
...
function embedVimeo(url, autoplay, background) {
  ...
  const temp = document.createElement('div');
  temp.innerHTML = `<div class="video-embed video-embed-vimeo">
    <iframe src="https://player.vimeo.com/video/${video}${suffix}"
      allow="autoplay; fullscreen; picture-in-picture" allowfullscreen loading="lazy" title="Vimeo video"></iframe>
  </div>`;
  return temp.children.item(0);
}
    ...
    if (!autoplay) {
      ...
      wrapper.insertAdjacentHTML(
        ...
        `<div class="video-placeholder-play">
          <button type="button" aria-label="${ariaLabel}" title="Play"></button>
        </div>`,
      );
